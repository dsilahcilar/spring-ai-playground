...
public class FactCheckingEvaluator implements Evaluator {
	...
	public EvaluationResponse evaluate2(EvaluationRequest evaluationRequest) {
		var response = evaluationRequest.getResponseContent();
		var context = doGetSupportingData(evaluationRequest);

		EvaluationResponse evaluationResponse = this.chatClientBuilder.build()
			.prompt()
	...
	@Override
	public org.springframework.ai.evaluation.EvaluationResponse evaluate(EvaluationRequest evaluationRequest) {
		return null;
	}

	@Override
	public String doGetSupportingData(EvaluationRequest evaluationRequest) {
		return Evaluator.super.doGetSupportingData(evaluationRequest);
	}
}
